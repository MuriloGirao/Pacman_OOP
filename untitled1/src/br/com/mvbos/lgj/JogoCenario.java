...
import br.com.Arquivo.PontuacaoJogadores;
        ...
        for (Pizza el : inimigos) {
            ...
            if (Util.colide(pizza, el)) {
                ...
                if (el.getModo() == Pizza.Modo.CACANDO) {
                    ...
                    String strNick = JOptionPane.showInputDialog("Insira seu Nome:");
                    //  System.out.println("Nilvel:*****"+M+"*****");
                    estado = JogoCenario.Estado.PERDEU;
                    pontuacaojogadores.adicionarJogador(strNick, pontos, String.valueOf(estado));
